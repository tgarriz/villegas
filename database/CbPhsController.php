...
class CbPhsController {
    ...
    public function readAll(){
        $query = "SELECT * FROM catastro.phs;";
 ...
 */
    function create($profesional,$objetos,$secuencia,$anio){
      $sqlInsert = "INSERT INTO catastro.phs(profesional,objetos,secuencia,anio)"
 ...
 */
   public function update($id,$profesional,$objetos,$secuencia,$anio){
    $sqlUpdate = "UPDATE catastro.phs SET profesional = ".$profesional.", objetos = '".$objetos."', secuencia = ".$secuencia.", anio = ".$anio." WHERE id = ".$id.";";
    try {
 ...
 */
   public function delete($id){
    $sqlDelete =
        "DELETE FROM catastro.phs WHERE id = ".$id.";";
    try {
