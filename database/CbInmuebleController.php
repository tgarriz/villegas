 ...
 */
   public function update($id,$circ,$secc,$chac_n,$chac_l,$quin_n,$quin_l,$frac_n,$frac_l,$manz_n,$manz_l,$parc_n,$parc_l,$subp,$superficie,$nro_puerta,$p_municipal,$domicilio,$tipo,$uso,$frente){
    $sqlUpdate = "UPDATE catastro.inmuebles SET circ = '".$circ."', secc = '".$secc."', chac_n = '".$chac_n."', quin_n = '".$quin_n."', quin_l = '".$quin_l."', frac_n = '".$frac_n."', frac_l = '".$frac_l."', manz_n = '".$manz_n."', manz_l = '".$manz_l."', parc_n = '".$parc_n."', parc_l = '".$parc_l."', subp = '".$subp."', superficie = ".$superficie.", nro_puerta = '".$nro_puerta."', p_municipal = '".$p_municipal."', domicilio = '".$domicilio."', tipo = '".$tipo."', frente = ".$frente.", uso = ".$uso." WHERE id = ".$id.";";
    try {
