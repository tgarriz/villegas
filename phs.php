                            ...
                            <form role="form" name="formEdit" method="post" action="phs.php">
                                <div class="modal-body">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="number" class="form-control" id="anio" name="anio" maxlength="4" min="1900" max="2030">
                                  </div>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form role="form" name="formCbPhs" method="post" action="phs.php">
                                <div class="modal-body">
                                  ...
                                  <div class="input-group">
                                      <label for="secuencia">Secuencia</label>
                                      <input type="number" class="form-control" id="secuencia" name="secuencia" maxlength="4" min="1" max="9999">
                                  </div>
                                  <div class="input-group">
                                      <label for="anio">Año</label>
                                      <input type="number" class="form-control" id="anio" name="anio" maxlength="4" min="1900" max="2030">
